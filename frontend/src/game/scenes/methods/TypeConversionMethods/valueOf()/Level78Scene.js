...
export class Level78Scene extends Phaser.Scene {
  ...
  async runBehavioralCheck() {
    ...
    try {
      ...
      console.warn("Level78Scene: /api/wellbeing/predict-struggle unreachable, skipping behavioral signal for this level:", e);
    }
  }
  ...
  levelComplete() {
    ...
    try { GameManager.completeLevel(78, Math.round((this.correctFirstTry / 15) * 100)); } catch (_) {}
