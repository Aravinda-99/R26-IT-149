...
export class Level46Scene extends Phaser.Scene {
  ...
  createArchiveBanner() {
    ...
    this.add.text(400, 43, "THE ARCHIVE", { font: "bold 14px Georgia", color: HEX_BRASS }).setOrigin(0.5).setAlpha(0.7).setDepth(3);
  }
  ...
  createBookshelf() {
    ...
    this.typeStampText = this.add.text(250, 150, "", { font: "bold 12px Courier New", color: HEX_CYAN }).setOrigin(0.5).setDepth(6);
    ...
    this.sizeCounterText = this.add.text(378, 148, "size: 0", { font: "bold 11px Courier New", color: HEX_BRASS }).setOrigin(0.5).setDepth(6);
  ...
  createBookPreparationArea() {
    ...
    this.add.text(PREP_X0 + 8, PREP_Y0 + 6, "NEW ENTRY", { font: "bold 10px Georgia", color: HEX_BRASS }).setAlpha(0.7).setDepth(5);
  ...
  async addBookToShelf(entry) {
    ...
    const label = this.add.text(SHELF_CX, targetY + 26, `[${idx}]`, { font: "bold 8px Courier New", color: HEX_BRASS }).setOrigin(0.5).setAlpha(0.6).setDepth(6);
  ...
  async rejectBook(book, idx) {
    ...
    const stamp = this.add.text(SHELF_CX, SHELF_Y0 + 60, "TYPE MISMATCH", { font: "bold 14px Courier New", color: HEX_RED }).setOrigin(0.5).setAngle(-8).setAlpha(0).setDepth(20);
  ...
  showCompileErrorStamp() {
    const stamp = this.add.text(SHELF_CX, 90, "COMPILE ERROR", { font: "bold 18px Arial", color: HEX_RED }).setOrigin(0.5).setDepth(30).setScale(1.4).setAngle(-6).setAlpha(0);
  ...
  createListStatePanel() {
    ...
    this.typeEchoText = this.add.text(PANEL_X + PANEL_W - 10, PANEL_Y + 40, "", { font: "bold 9px Courier New", color: HEX_GRAY }).setOrigin(1, 0.5).setAlpha(0.6).setDepth(12);
    this.bracketText = this.add.text(PANEL_X + PANEL_W / 2, PANEL_Y + 110, "[]", { font: "bold 15px Courier New", color: HEX_GRAY }).setOrigin(0.5).setDepth(12);
    this.panelSizeText = this.add.text(PANEL_X + PANEL_W / 2, PANEL_Y + 150, "size: 0", { font: "11px Courier New", color: HEX_BRASS }).setOrigin(0.5).setAlpha(0.85).setDepth(12);
    this.panelIndexText = this.add.text(PANEL_X + PANEL_W / 2, PANEL_Y + 175, "", { font: "bold 10px Courier New", color: "#8a6435" }).setOrigin(0.5).setAlpha(0.7).setDepth(12);
  }
  ...
  createHUD() {
    ...
    this.add.text(20, 14, "THE ARCHIVE", { font: "bold 15px Georgia", color: "#b0bec5" }).setDepth(50);
    this.add.text(20, 32, "Accretion Phase — ArrayList Methods: add()", { font: "11px Arial", color: "#546e7a" }).setDepth(50);
  ...
  async onBubbleSelected(opt, config, bubbleContainer) {
    ...
    if (config.revealNote) this.createFloatingText(PANEL_X + PANEL_W / 2, PANEL_Y + PANEL_H + 30, config.revealNote, HEX_GRAY, "11px Arial", 2800);
  ...
  createCartridgeTray(config) {
    ...
    bdraw(false, false);
    const bt = this.add.text(0, 0, "FILE", { font: "bold 14px Arial", color: "#0a0704" }).setOrigin(0.5);
    btn.add([bg, bt]);
    btn.setSize(120, 44);
  ...
  gameOver() {
    ...
    (async () => {
      ...
      this._makeButton(640, 420, "RETURN TO THE STACKS", 230, 50, { stroke: C_RED, textColor: HEX_RED }, () => this.scene.restart());
    })();
  }
  ...
  showScoreTally() {
    ...
    const badgeLbl = this.add.text(640, 505, "add() SCHEMA ACQUIRED", { font: "bold 13px Arial", color: HEX_GOLD }).setOrigin(0.5).setDepth(91).setAlpha(0);
