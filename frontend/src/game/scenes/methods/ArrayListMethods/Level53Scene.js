...
export class Level53Scene extends Phaser.Scene {
  ...
  createAuctioneersPodium() {
    ...
    this.add.text(110, 460, "LOT SALE", { font: "bold 9px Georgia", color: HEX_BRASS }).setOrigin(0.5).setAlpha(0.6).setDepth(4);
  ...
  createSoldLotShelf() {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      const tag = this.add.text(x + 20, 150, "SOLD", { font: "bold 7px Georgia", color: HEX_GRAY }).setOrigin(0.5).setDepth(3);
      p.setDepth(2);
  ...
  createClearingSaleBanner() {
    ...
    this.add.text(400, 43, "T H E   C L E A R I N G   S A L E", { font: "bold 13px Georgia", color: HEX_BRASS }).setOrigin(0.5).setAlpha(0.7).setDepth(3);
  }
  ...
  createClearingDesk() {
    ...
    this.ticketLabel = this.add.text(TICKET_X1 - 10, TICKET_Y0 + 8, "", { font: "bold 9px Courier New", color: "#8a6435" }).setOrigin(1, 0).setAlpha(0.7).setDepth(6);
    this.ticketQuestionText = this.add.text(TICKET_CX, TICKET_Y1 - 16, "", { font: "12px Georgia", color: "#241a0e" }).setOrigin(0.5).setDepth(6);
  ...
  async stampTicket(kind) {
    ...
    const stamp = this.add.text(TICKET_CX, TICKET_CY, labels[kind], { font: "bold 20px Georgia", color: colors[kind] }).setOrigin(0.5).setDepth(30).setScale(1.4).setAngle(-8).setAlpha(0);
  ...
  createPocketWatch() {
    ...
    ["12", "3", "6", "9"].forEach((label, i) => {
      ...
      const t = this.add.text(tx, ty, label, { font: "bold 9px Georgia", color: "#241a0e" }).setOrigin(0.5).setAlpha(0.7);
      this.watch.add(t);
    });
  ...
  createReferenceBookshelf() {
    ...
    this.typeStampText = this.add.text(SHELF_X0 + 71, 106, "", { font: "bold 9px Courier New", color: HEX_CYAN }).setOrigin(0.5).setDepth(6);
    ...
    this.sizeCounterText = this.add.text(SHELF_X1 - 41, 106, "size: 0", { font: "bold 9px Courier New", color: HEX_BRASS }).setOrigin(0.5).setDepth(6);
    ...
    for (let i = 0; i < 7; i++) {
      ...
      const idxText = this.add.text(SHELF_X0 + 20, y, String(i), { font: "bold 11px Courier New", color: HEX_GRAY }).setOrigin(0.5).setDepth(7);
  ...
  _makeBookVisual(entry, x, y) {
    ...
    const txt = this.add.text(0, 0, display, { font: "bold 9px Georgia", color: "#0a0704" }).setOrigin(0.5);
    if (display.length > 5) { txt.setAngle(-90); if (txt.width > 26) txt.setFontSize(7); }
    const label = this.add.text(0, 19, "", { font: "bold 7px Courier New", color: HEX_BRASS }).setOrigin(0.5).setAlpha(0.6);
    c.add([g, txt, label]);
  ...
  createReferenceCrate() {
    ...
    this.crateLabel = this.add.text(CRATE_CX, CRATE.y0 + 12, "WITHDRAWN", { font: "bold 9px Georgia", color: HEX_STAMP_RED }).setOrigin(0.5).setAlpha(0.5).setAngle(-2).setDepth(9);
  }
  ...
  createReferenceListStatePanel() {
    ...
    this.add.text(PANEL_X + 10, PANEL_Y + 14, "LIST STATE", { font: "bold 10px Georgia", color: HEX_BRASS }).setOrigin(0, 0.5).setDepth(12);
    ...
    this.bracketText = this.add.text(PANEL_X + PANEL_W / 2, PANEL_Y + 74, "[]", { font: "bold 13px Courier New", color: HEX_GRAY, wordWrap: { width: PANEL_W - 24 }, align: "center" }).setOrigin(0.5).setDepth(12);
    this.panelSizeText = this.add.text(PANEL_X + PANEL_W / 2, PANEL_Y + 108, "size: 0", { font: "10px Courier New", color: HEX_BRASS }).setOrigin(0.5).setAlpha(0.85).setDepth(12);
    this.panelIndexText = this.add.text(PANEL_X + PANEL_W / 2, PANEL_Y + 126, "", { font: "bold 9px Courier New", color: "#8a6435", wordWrap: { width: PANEL_W - 24 }, align: "center" }).setOrigin(0.5).setAlpha(0.7).setDepth(12);

    this.add.text(PANEL_X + 14, PANEL_Y + 150, "removed:", { font: "10px Georgia", color: "#8a6435" }).setOrigin(0, 0.5).setDepth(12);
    this.removedValueText = this.add.text(PANEL_X + 76, PANEL_Y + 150, "—", { font: "bold 11px Courier New", color: HEX_GRAY }).setOrigin(0, 0.5).setDepth(12);

    this.add.text(PANEL_X + 14, PANEL_Y + 174, "before:", { font: "9px Courier New", color: "#8a6435" }).setOrigin(0, 0.5).setDepth(12);
    this.beforeRowText = this.add.text(PANEL_X + 66, PANEL_Y + 174, "", { font: "bold 9px Courier New", color: "#b0bec5" }).setOrigin(0, 0.5).setDepth(12);
    this.add.text(PANEL_X + 14, PANEL_Y + 192, "after:", { font: "9px Courier New", color: "#8a6435" }).setOrigin(0, 0.5).setDepth(12);
    this.afterRowText = this.add.text(PANEL_X + 66, PANEL_Y + 192, "", { font: "bold 9px Courier New", color: HEX_GREEN_BRIGHT }).setOrigin(0, 0.5).setDepth(12);

    this.add.text(PANEL_X + 14, PANEL_Y + 214, "returned:", { font: "9px Georgia", color: "#8a6435" }).setOrigin(0, 0.5).setDepth(12);
    this.returnedFlagText = this.add.text(PANEL_X + 80, PANEL_Y + 214, "", { font: "bold 10px Courier New", color: HEX_VIOLET }).setOrigin(0, 0.5).setDepth(12);
  }
  ...
  createMutationTracker() {
    ...
    this.add.text(TRK_X + 10, TRK_Y + 12, "MUTATION TRACKER", { font: "bold 10px Georgia", color: HEX_BRASS }).setOrigin(0, 0.5).setDepth(11);
    this.trackerContainer = this.add.container(0, 0).setDepth(12);
    this._trackerRows = [];
    this._trackerDash = this.add.text(TRK_X + TRK_W / 2, TRK_Y + TRK_H / 2 + 6, "—", { font: "bold 14px Courier New", color: "#3a2618" }).setOrigin(0.5).setDepth(11);
  }
  ...
  appendTrackerRow(text, isCrash) {
    ...
    const t = this.add.text(TRK_X + 10, y, text, { font: "9px Courier New", color: isCrash ? HEX_RED : "#e8dfc8" }).setAlpha(0);
  ...
  clearTracker() {
    ...
    this._trackerRows = [];
    if (!this._trackerDash) this._trackerDash = this.add.text(TRK_X + TRK_W / 2, TRK_Y + TRK_H / 2 + 6, "—", { font: "bold 14px Courier New", color: "#3a2618" }).setOrigin(0.5).setDepth(11);
  }
  ...
  _popReturnValue(entry, fromX, fromY) {
    const valText = this.add.text(fromX, fromY, String(entry.value), { font: "bold 14px Courier New", color: this._typeColorHex(entry.type) }).setOrigin(0.5).setDepth(30);
  ...
  flagArgumentAsIndex(value) {
    const t = this.add.text(TICKET_CX + 30, TICKET_CY - 40, `index`, { font: "bold 8px Courier New", color: HEX_GOLD }).setOrigin(0.5).setDepth(20).setAlpha(0);
  ...
  renderBoxedArgument(value) {
    ...
    const t = this.add.text(0, 0, String(value), { font: "bold 11px Courier New", color: HEX_GOLD }).setOrigin(0.5);
    const flag = this.add.text(0, -18, "Integer", { font: "bold 7px Courier New", color: HEX_CYAN }).setOrigin(0.5);
    c.add([g, t, flag]);
  ...
  async crashWithdrawal(index) {
    ...
    const stamp = this.add.text(SHELF_CX, SHELF_Y0 + 40, "IndexOutOfBoundsException", { font: "bold 9px Courier New", color: HEX_RED }).setOrigin(0.5).setAngle(-6).setAlpha(0).setDepth(25);
    this.add.existing ? null : null;
  ...
  showSkippedFlag(index) {
    ...
    const t = this.add.text(SHELF_CX + 100, y, "skipped!", { font: "italic 9px Georgia", color: HEX_RED }).setOrigin(0.5).setDepth(20).setAlpha(0);
    this.roundElements.push(t);
  ...
  createHUD() {
    ...
    this.add.text(20, 14, "THE CLEARING SALE", { font: "bold 15px Georgia", color: "#b0bec5" }).setDepth(50);
    this.add.text(20, 32, "Tuning Phase — ArrayList Methods: remove()", { font: "11px Arial", color: "#546e7a" }).setDepth(50);
  ...
  async onBubbleSelected(opt, config, bubbleContainer) {
    ...
    this.fillAfterRow();
    if (config.revealNote) this.createFloatingText(TICKET_CX + 60, 430, config.revealNote, HEX_GRAY, "10px Arial", 2800);
  ...
  setupBugHunt(config) {
    this.clearTicket();
    const header = this.add.text(TICKET_CX, TICKET_Y0 + 16, "CLICK THE BUG", { font: "bold 13px Georgia", color: "#c62828" }).setOrigin(0.5);
  ...
  async onTokenClicked(tokenObj, config, lineY) {
    ...
    if (correct) {
      ...
      const fixT = this.add.text(TICKET_CX, lineY - 14, config.fix, { font: "bold 10px Courier New", color: "#2e7d32", wordWrap: { width: 340 } }).setOrigin(0.5).setAlpha(0);
  ...
  scoreForAttempt(timePctUsed) {
    ...
    if (remaining > 0.6) { points += 50; this.fastBonusCount++; this.createFloatingText(TICKET_CX, TICKET_Y0 - 20, "⚡ SWIFT GAVEL +50", HEX_GOLD, "bold 13px Arial", 900); }
    else if (remaining > 0.3) { points += 25; this.fastBonusCount++; this.createFloatingText(TICKET_CX, TICKET_Y0 - 20, "⚡ +25", HEX_GOLD, "bold 12px Arial", 800); }
    return points;
  }
  ...
  gameOver() {
    ...
    (async () => {
      ...
      this.add.text(640, 350, `Lots Cleared: ${this.currentRound} / 15`, { font: "16px Arial", color: HEX_GRAY }).setOrigin(0.5).setDepth(91);
      this._makeButton(640, 420, "WIND THE WATCH", 220, 50, { stroke: C_RED, textColor: HEX_RED }, () => this.scene.restart());
    })();
  }
  ...
  levelComplete() {
    ...
    try { GameManager.completeLevel(52, Math.round((this.correctFirstTry / 15) * 100)); } catch (_) {}
  ...
  showScoreTally() {
    ...
    const badgeLbl = this.add.text(640, 485, "remove() SCHEMA TUNED", { font: "bold 13px Georgia", color: HEX_GOLD }).setOrigin(0.5).setDepth(91).setAlpha(0);
