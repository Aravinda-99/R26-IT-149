 ...
 * Login Page
 * ==========
 * Premium student-friendly login UI (restored from login/reg updates commit).
...
export function renderLogin(container, onNavigate) {
        ...
        <div style="min-height: 85vh; display: flex; align-items: center; justify-content: center; padding: 2rem;">
            ...
            <style>
                ...
                .premium-btn {
                    width: 100%;
                    padding: 1rem;
                    background: linear-gradient(135deg, var(--accent-blue, #4a90e2), #3b82f6);
                    color: #fff;
                    border: none;
                    border-radius: 12px;
                    font-size: 1rem;
            ...
            <div class="premium-login-card">
                <div style="text-align: center; margin-bottom: 2.5rem;">
                    <div style="font-size: 3rem; color: var(--accent-blue, #4a90e2); margin-bottom: 1rem; animation: pulseGlow 2s infinite; border-radius: 50%; display: inline-block;">
                        <i class="fas fa-cube"></i>
                    </div>
                    <h1 class="form-title">CodeQuest</h1>
                    <p style="color: var(--text-secondary, #8899aa); font-size: 0.95rem;">Unlock your programming potential</p>
                </div>
                ...
                <div>
                    ...
                    <p style="text-align: center; margin-top: 1.5rem; font-size: 0.9rem; color: var(--text-secondary, #8899aa);">
                        ...
                        <a href="#" id="go-register" style="color: var(--accent-purple, #a78bfa); text-decoration: none; font-weight: 600; margin-left: 0.3rem;">Create one</a>
                    </p>
    ...
    document.getElementById("login-btn").addEventListener("click", async () => {
        ...
        try {
            ...
            if (onNavigate) {
                onNavigate(role === "teacher" || role === "admin" ? "/teacher/dashboard" : "/student/dashboard");
            }
        } catch (e) {
